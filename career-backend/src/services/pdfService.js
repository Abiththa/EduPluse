        ...
        <div class="container">
          <div class="header">
            ...
            <div class="contact">
              ...
              ${personal.portfolio ? `<span>🌐 ${escapeHtml(personal.portfolio)}</span>` : ""}
            </div>
          </div>
                ...
                <div class="item">
                  <div class="item-header">
                    <div>
                      ...
                      ${
                        item.fieldOfStudy
                          ? `<div class="muted">${escapeHtml(item.fieldOfStudy)}</div>`
                          : ""
                      }
                    </div>
                    <div class="item-date">${escapeHtml(
                ...
                <div class="item">
                  <div class="item-header">
                    <div>
                      ...
                      ${
                        item.link
                          ? `<div class="muted">🔗 ${escapeHtml(item.link)}</div>`
                          : ""
                      }
                    </div>
                  </div>
                  ...
                  ${
                    Array.isArray(item.technologies) && item.technologies.length
                      ? `<div class="chips" style="margin-top:8px;">${item.technologies
